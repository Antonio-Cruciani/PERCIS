...
for eps in epsilon_list
    for ds in datasets
        ...
        for i in 1:runs
            ...
            args = `-f -v 10 -s $sampling_rate_ -o $op -t $tn $eps $delta $ps $gf`
            @info("----------------------------------------------------------------------------------")
            @info("Run Number $i")
            for line in eachline(`../percis/percis $args`)
                @info("$line")
...
for eps in epsilon_list
    for ds in datasets
        ...
        for i in 1:runs
            ...
            #println(ps)
            #args = `-v 1 -g $ss -o $op -t $tn $epsilon $delta $ps $gf`
            args = `-i -v 10 -s $sampling_rate_ -o $op -t $tn $eps $delta $ps $gf`
            @info("----------------------------------------------------------------------------------")
            @info("Run Number $i")
            for line in eachline(`../percis/percis $args`)
                @info("$line")
            ...
            op_times = "non_uniform_di_ss_"*string(j)*".txt"
            #op_times = "uniform_ss_"*string(j)*".txt"
...
for eps in epsilon_list
    for ds in datasets
        ...
        for i in 1:runs
            ...
            #println(ps)
            #//output = read(`./aperitif -v 1 -g $ss -o $op -t $tn $epsilon $delta $ps $gf`, String)
            args = `-f -d -v 10 -s $sampling_rate_ -o $op -t $tn $eps $delta $ps $gf`
...
for eps in epsilon_list
    for ds in datasets
        ...
        for i in 1:runs
            ...
            #println(ps)
            args = `-i -d -v 10 -s $sampling_rate_ -o $op -t $tn $eps $delta $ps $gf`
            #args = `-d -u -v 1 -o $op -t $tn $eps $delta $ps $gf`
            @info("----------------------------------------------------------------------------------")
            @info("Run Number $i")
            for line in eachline(`../percis/percis $args`)
...
for eps in epsilon_list
    for ds in datasets
        ...
        for i in 1:runs
            ...
            #println(ps)
            args = `-v 10 -d -s $sampling_rate_ -o $op -t $tn $eps $delta $ps $gf`
            #args = `-u -v 1 -g $ss -o $op -t $tn $epsilon $delta $ps $gf`
            @info("----------------------------------------------------------------------------------")
            @info("Run Number $i")
            for line in eachline(`../percis/percis $args`)
